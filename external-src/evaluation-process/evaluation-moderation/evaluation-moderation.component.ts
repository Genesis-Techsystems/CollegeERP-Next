...
@Component({
  selector: 'app-evaluation-moderation',
  templateUrl: './evaluation-moderation.component.html',
  styleUrls: ['./evaluation-moderation.component.scss']
})
export class EvaluationModerationComponent implements OnInit {
  ...
  Assign() {
    ...
    let request = [
      { paramName: 'in_flag', paramValue: 'AssignModerationEvaluation' },
