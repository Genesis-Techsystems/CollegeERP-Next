...
export interface InvStore {
  ...
  storeName?: string;
  empName?: string;
  /** Comma-separated college IDs — Angular form field `collegeIds`. */
  collegeIds?: string;
  /** Display names returned by list API — Angular table `row.colleges`. */
  colleges?: string[];
  employeeId?: number;
  isActive: boolean;
  reason?: string;
...
export interface InvItem {
  ...
  make?: string;
  model?: string;
  /** Comma-separated supplier IDs — Angular form field `supplierIds`. */
  supplierIds?: string;
  supplierId?: number;
  supplierName?: string;
...
export interface InvPurchaseOrderListRow {
  ...
  poType?: string;
  /** Angular Status column shows workflow name, not isActive. */
...
export interface InvPurchaseReturn {
  /** Angular PK on get/save — lowercase `return` */
...
/** Nested item on InvInternalIndent (list/get / view modal). */
export interface InvInternalIndentItemRow {
...
export interface InvInternalIssue {
  ...
  invTranstypeCatdetIdDisplayName?: string;
  invTranstypeCatdetDisplayName?: string;
  /** Angular list shows first item's indentQuantity */
  Quantity?: number;
  isActive?: boolean;
  invInternalIssueItemDTOs?: InvInternalIssueItemRow[];
}
