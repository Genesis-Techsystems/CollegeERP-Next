...
export interface UnivRemunerationSetting {
  ...
  /** Angular table column `remunerationDesignationDisplayName`. */
  remunerationDesignationDisplayName?: string;
  amount?: number;
...
export interface RemunerationPaymentSummary {
  ...
  total_nos?: number;
  total_amount?: number;
  fk_univ_remuneration_trsansaction_id?: number | null;
  pk_univ_examinationremuneration_ids?: string;
  fk_exam_evaluator_profile_id?: number;
...
/** POST body for `RazorPay/updateRemunerationDetails/{ids}` (Angular add-remuneration-payment submit). */
export interface RemunerationPaymentWritePayload {
  organizationId: number;
  examEvaluatorProfileId: number | null;
  employeeId: null;
  evaluatorRoleId: number | null;
  remunerationForcatDetID: null;
  transactionAmount: number;
  transactionDate: string;
  transactionByEmpId: number | string;
...
export interface UnivExamFilterRow {
  ...
  from_date?: string;
  to_date?: string;
  is_internal_exam?: boolean | number;
  is_regular_exam?: boolean | number;
  is_supply_exam?: boolean | number;
}
