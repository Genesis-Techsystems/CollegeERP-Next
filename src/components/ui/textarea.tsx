    ...
    return (
      <textarea
        className={cn(
          ...
          isStandard
            ? "min-h-[3.8rem] h-auto rounded-none border-0 border-b border-black/12 bg-transparent px-0 py-1.5 shadow-none focus:border-b-2 focus:border-[#0c51a4] focus:ring-0"
