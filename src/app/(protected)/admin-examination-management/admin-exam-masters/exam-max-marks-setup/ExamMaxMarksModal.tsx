...
import { saveMarksSetup } from '@/services/exam-max-marks.service'
...
interface ExamMaxMarksModalProps {
  ...
  onSaved: () => void
  /** Query key prefix used to invalidate the marks setup list */
  queryKey: unknown[]
}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-2">
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              onCheckedChange={(v) => {
                ...
                setValue('reason', Boolean(v) ? 'active' : '')
              }}
            />
          ...
          {!isActiveVal && (
            <div className="space-y-1.5">
              ...
              <Input id="reason" {...register('reason')} placeholder="Enter reason..." />
              {errors.reason && (
