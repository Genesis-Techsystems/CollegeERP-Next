    ...
    try {
      ...
      setSubmitError(
        error instanceof Error
          ? error.message
          : "Failed to save reservation sub category",
      );
    }
  }

  const dialogTitle = isEditing
    ? "Edit Sub Reservation Category"
          ...
          <Controller
            ...
            render={({ field }) => (
              <div className="flex items-center gap-2 pt-1">
                ...
                />
                <Label htmlFor="isEligibleForReservation">
