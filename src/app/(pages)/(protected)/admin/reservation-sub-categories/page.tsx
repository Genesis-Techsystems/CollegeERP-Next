...
const COLS = {
  ...
  subCaste: {
    colId: "subCaste",
    field: "subCaste",
    headerName: "Sub Caste Name",
    minWidth: 170,
    flex: 1.2,
  } as ColDef<SubCaste>,
  isEligibleForReservation: {
    colId: "isEligibleForReservation",
    field: "isEligibleForReservation",
    headerName: "Is Eligible For Reservation",
    minWidth: 180,
    flex: 1.1,
  } as ColDef<SubCaste>,
  sortOrder: {
...
export default function ReservationSubCategoriesPage() {
  ...
  const { data, isLoading, invalidate } = useCrudList({
    queryKey: QK.subCastes.list(),
    queryFn: listSubCastes,
  });
  ...
  return (
    <ListPage
      title="Sub Reservation Categories"
      rowData={data}
      ...
      toolbar={{
        ...
        pdfDocumentTitle: "Sub Reservation Categories",
      }}
      toolbarTrailing={
        <Button
          size="sm"
