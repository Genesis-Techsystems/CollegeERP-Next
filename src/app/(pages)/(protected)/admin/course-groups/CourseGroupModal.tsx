...
export default function CourseGroupModal({
  ...
  async function onSubmit(data: FormValues) {
    ...
    try {
      ...
      setSubmitError(
        e instanceof Error ? e.message : "Failed to save course group",
      );
    }
  }
      ...
      <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-2 py-1">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <Label htmlFor="cgn">Course Group Name *</Label>
              <Input id="cgn" {...register("groupName")} />
              {errors.groupName && (
            ...
            <div>
              <Label htmlFor="cgc">Course Group Code *</Label>
              <Input id="cgc" {...register("groupCode")} />
              {errors.groupCode && (
                <p className="text-xs text-red-500">
            ...
            <div>
              <Label htmlFor="cgsn">Group Short Name *</Label>
              <Input id="cgsn" {...register("shortName")} />
              {errors.shortName && (
                <p className="text-xs text-red-500">
            ...
            <div>
              <Label htmlFor="cgep">Prefix *</Label>
              <Input id="cgep" {...register("enrollPrefix")} />
              {errors.enrollPrefix && (
                <p className="text-xs text-red-500">
                  {errors.enrollPrefix.message}
                </p>
              )}
            </div>
            <div>
              <Label htmlFor="cgsno">Starting No *</Label>
              <Input id="cgsno" {...register("startingNo")} />
              {errors.startingNo && (
                <p className="text-xs text-red-500">
                  {errors.startingNo.message}
                </p>
              )}
            </div>
          </div>
