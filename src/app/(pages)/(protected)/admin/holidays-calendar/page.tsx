  ...
  return (
    <PageContainer className="space-y-5">
      <div className="app-card overflow-hidden">
        ...
        >
          <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Holidays Calendar Filters</h2>
      ...
      {showTable && (
        <div className="app-card overflow-hidden">
          <div className="px-3 py-2.5 border-b border-slate-200 bg-slate-50/60">
            <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Holidays Calendar</h2>
          </div>
          <div className="px-3 pb-3 pt-2">
            <DataTable
