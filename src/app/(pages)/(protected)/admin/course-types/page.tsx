...
const COLS = {
  siNo: { headerName: 'SI.No', valueGetter: rowIndexGetter, width: 70, flex: 0 } as ColDef<CourseType>,
  university: { headerName: 'University', minWidth: 140, flex: 1 } as ColDef<CourseType>,
  code: { headerName: 'Course Type Code', minWidth: 150, flex: 1 } as ColDef<CourseType>,
  name: { headerName: 'Course Type Name', minWidth: 170, flex: 1.2 } as ColDef<CourseType>,
  isActive: { field: 'isActive', headerName: 'Status', minWidth: 90, flex: 0.7 } as ColDef<CourseType>,
  actions: { headerName: 'Actions', minWidth: 86, width: 86, flex: 0 } as ColDef<CourseType>,
}
  ...
  return (
    <PageContainer className="space-y-5">
      <div className="app-card overflow-hidden">
        ...
        <div className="p-3"><SearchInput className="max-w-sm" placeholder="Search subject types..." value={search} onChange={setSearch} /></div>
