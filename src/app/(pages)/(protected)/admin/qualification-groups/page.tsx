...
const COLS = {
  ...
  qualificationGroupName: {
    colId: "qualificationGroupName",
    field: "qualificationGroupName",
    headerName: "Qualification Group Name",
    minWidth: 190,
    flex: 1.2,
  } as ColDef<QualificationGroup>,
  qualificationGroupCode: {
    colId: "qualificationGroupCode",
    field: "qualificationGroupCode",
    headerName: "Qualification Group Code",
    minWidth: 170,
    flex: 1.1,
  } as ColDef<QualificationGroup>,
  sortOrder: {
...
function actionRenderer(
  setRow: (r: QualificationGroup | null) => void,
  ...
  return (
    <ListPage
      ...
      toolbar={{
        ...
        searchClassName: "max-w-none sm:max-w-[40%]",
        pdfDocumentTitle: "Qualification Groups",
      }}
      toolbarTrailing={
        <Button
          size="sm"
