...
import { listAchievementCategories } from '@/services/placements'
...
export default function AchievementCategoriesPage() {
  ...
  const columnDefs = useMemo<ColDef<AchievementCategory>[]>(() => [
    ...
    { field: 'achievementCategory', headerName: 'Category Name', minWidth: 160, flex: 2 },
    { field: 'achievementCategoryCode', headerName: 'Code', minWidth: 100, flex: 1 },
    { field: 'organizationName', headerName: 'Organization', minWidth: 140, flex: 1 },
    {
      field: 'isActive', headerName: 'Status', minWidth: 90, flex: 0.8,
      cellRenderer: (p: ICellRendererParams<AchievementCategory>) => (
