    ...
    <PageContainer className="space-y-4">
      ...
      {mainTab === 'discontinue' && (
        <div className="app-card p-4 space-y-4">
          <div className="flex flex-wrap items-center gap-6 text-sm border-b border-slate-200 pb-3">
            <label className="inline-flex items-center gap-2">
              <input
                type="radio"
                  ...
                  return (
                    <tr key={`dc-${sid}-${index}`} className="border-t">
                      <td className="px-2 py-1 align-middle">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-slate-100 text-slate-500">
