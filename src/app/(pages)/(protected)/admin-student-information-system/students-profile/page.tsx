...
import { fetchStudentDetail, fetchStudentProfileFeeLedgerSummary } from '@/services'
...
export default function StudentsProfilePage() {
  ...
  const isStudentPortal = userTypeCode === 'STUDENT' || userTypeCode === 'PARENT'
  const studentId = isStudentPortal ? Number(readStorage('studentId') || 0) : queryStudentId
  ...
  function goBack() {
    ...
    if (check === 1) {
      ...
      if (student.academicYearId) params.set('academicYearId', String(student.academicYearId))
      ...
      if (student.courseGroupId) params.set('courseGroupId', String(student.courseGroupId))
      if (student.courseYearId) params.set('courseYearId', String(student.courseYearId))
      if (student.groupSectionId != null) params.set('groupSectionId', String(student.groupSectionId))
    }
