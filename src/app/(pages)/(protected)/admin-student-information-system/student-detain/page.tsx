      ...
      {rows.length > 0 && (
        <div className="app-card overflow-hidden">
          <div className="px-3 py-2.5 border-b border-slate-200 bg-slate-50/60">
            <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Detain</h2>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-3">
              <div className="border rounded overflow-hidden">
                <div className="bg-slate-50 px-3 py-2 border-b flex items-center justify-between text-[12px] font-semibold">
