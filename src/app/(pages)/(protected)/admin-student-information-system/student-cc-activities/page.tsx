  ...
  return (
    <PageContainer className="space-y-4">
      ...
      <div className="app-card overflow-hidden">
        <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50/60 px-3 py-2.5">
          <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Student Co-Curriculum Activities</h2>
          <Button
            type="button"
            variant="outline"
            size="sm"
