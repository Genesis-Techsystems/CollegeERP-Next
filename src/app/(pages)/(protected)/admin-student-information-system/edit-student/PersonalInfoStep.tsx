  ...
  return (
    <div className="space-y-5">
      ...
      <FieldGrid>
        <Select
          label="Title"
          placeholder={EDIT_PLACEHOLDERS.title}
        ...
        <div className="space-y-1">
          <Label className="text-xs">First Name (as per SSC) *</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.firstName}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.middleName}
            value={txt(data, ["middleName"])}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.lastName}
            value={txt(data, ["lastName"])}
        ...
        <div className="space-y-1">
          ...
          <DatePicker
            placeholder={EDIT_PLACEHOLDERS.dateOfBirth}
            value={dob}
        ...
        <div className="flex flex-wrap items-end gap-4 lg:col-span-2">
          ...
          />
          <PhotoField
            src={props.signaturePhotoUrl}
            onFile={props.onSignaturePhoto}
            label="Signature"
          />
        </div>
        <div className="space-y-1">
        ...
        <div className="space-y-1">
          <Label className="text-xs">SSC Number</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.sscNo}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.identificationMarks}
        ...
        <Select
          ...
          placeholder={EDIT_PLACEHOLDERS.qualifyExam}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.eamcetRank}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.entranceHTNumber}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.mobile}
        ...
        <div className="space-y-1">
          ...
          <Input
            type="email"
            placeholder={EDIT_PLACEHOLDERS.email}
            value={txt(data, ["stdEmailId", "studentEmailId"])}
            onChange={(e) => onChange({ stdEmailId: e.target.value })}
          />
        </div>
        <Select
          label="Nationality"
          placeholder={EDIT_PLACEHOLDERS.nationality}
        ...
        <Select
          label="Religion"
          placeholder={EDIT_PLACEHOLDERS.religion}
        ...
        <Select
          label="Caste"
          placeholder={EDIT_PLACEHOLDERS.caste}
        ...
        <Select
          label="Sub Caste"
          placeholder={EDIT_PLACEHOLDERS.subCaste}
        ...
        <Select
          label="Disability"
          placeholder={EDIT_PLACEHOLDERS.disability}
        ...
        <Select
          label="Blood Group"
          placeholder={EDIT_PLACEHOLDERS.bloodGroup}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.aadharCardNo}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.pancardNo}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.passportNo}
        ...
        <div className="space-y-1">
          ...
          <DatePicker
            placeholder={EDIT_PLACEHOLDERS.issueDate}
        ...
        <div className="space-y-1">
          ...
          <DatePicker
            placeholder={EDIT_PLACEHOLDERS.expiryDate}
      ...
      <FieldGrid>
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.fatherName}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.fatherOccupation}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.fatherQualification}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.fatherIncome}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.fatherMobile}
        ...
        <div className="space-y-1">
          ...
          <Input
            type="email"
            placeholder={EDIT_PLACEHOLDERS.fatherEmail}
        ...
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.fatherAddress}
      ...
      <FieldGrid>
        <div className="space-y-1">
          ...
          <Input
            placeholder={EDIT_PLACEHOLDERS.motherName}
        ...
        <div className="space-y-1">
          <Label className="text-xs">Occupation</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.motherOccupation}
        ...
        <div className="space-y-1">
          <Label className="text-xs">Qualification</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.motherQualification}
        ...
        <div className="space-y-1">
          <Label className="text-xs">Annual Income</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.motherIncome}
        ...
        <div className="space-y-1">
          <Label className="text-xs">Mobile Number</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.motherMobile}
        ...
        <div className="space-y-1">
          ...
          <Input
            type="email"
            placeholder={EDIT_PLACEHOLDERS.motherEmail}
        ...
        <div className="space-y-1">
          <Label className="text-xs">Address</Label>
          <Input
            placeholder={EDIT_PLACEHOLDERS.motherAddress}
      ...
      <div className="px-1">
        ...
        <RadioGroup
          value={data.isLocal === false ? "nonlocal" : "local"}
          onValueChange={(v) => onChange({ isLocal: v === "local" })}
  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <div className="space-y-1 sm:col-span-2">
        ...
        <Input
          placeholder={EDIT_PLACEHOLDERS.addressLine}
      ...
      <Select
        label="Country"
        placeholder={EDIT_PLACEHOLDERS.country}
      ...
      <Select
        label="State"
        placeholder={EDIT_PLACEHOLDERS.state}
      ...
      <Select
        label="District"
        placeholder={EDIT_PLACEHOLDERS.district}
      ...
      <Select
        label="City"
        placeholder={EDIT_PLACEHOLDERS.city}
      ...
      <div className="space-y-1">
        ...
        <Input
          placeholder={EDIT_PLACEHOLDERS.street}
      ...
      <div className="space-y-1">
        ...
        <Input
          placeholder={EDIT_PLACEHOLDERS.mandal}
      ...
      <div className="space-y-1">
        ...
        <Input
          placeholder={EDIT_PLACEHOLDERS.pincode}
