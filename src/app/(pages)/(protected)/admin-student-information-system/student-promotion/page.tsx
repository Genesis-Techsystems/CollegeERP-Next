    ...
    <PageContainer className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="app-card overflow-hidden">
          <div className="flex items-center justify-between gap-2 border-b border-slate-200 bg-slate-50/60 px-3 py-2.5">
            <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Promote From</h2>
            <Button
              type="button"
              variant="outline"
              size="sm"
        ...
        <div className="app-card overflow-hidden">
          <div className="flex items-center justify-between gap-2 border-b border-slate-200 bg-slate-50/60 px-3 py-2.5">
            <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Promote To</h2>
            <Button
              type="button"
              variant="outline"
              size="sm"
