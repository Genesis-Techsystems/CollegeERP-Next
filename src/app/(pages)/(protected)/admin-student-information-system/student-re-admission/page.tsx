    ...
    <PageContainer className="space-y-4">
      ...
      <div className="app-card overflow-hidden">
        <div className="px-3 py-2.5 border-b border-slate-200 bg-slate-50/60 flex items-center justify-between gap-2">
          <h2 className="text-[14px] font-semibold text-[hsl(var(--primary))]">Student Detained List</h2>
          <Button
            type="button"
            variant="outline"
            size="sm"
                  ...
                  return (
                    <tr key={`detained-${sid}-${index}`} className="border-t">
                      <td className="px-2 py-1 align-middle">
                        <div
                          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-slate-100 text-slate-500"
                          aria-hidden
                        >
