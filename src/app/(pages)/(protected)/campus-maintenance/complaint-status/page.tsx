...
const COL_DEFS = {
  ...
  collegeCode: { field: 'collegeCode', headerName: 'College Code', minWidth: 120, flex: 0.9 } as ColDef<CampusIssue>,
    ...
    () => [
      ...
      { ...COL_DEFS.status, cellRenderer: statusRenderer },
      {
        ...
        cellRenderer: makeActionsRenderer(
          (issue) =>
            router.push(`/campus-maintenance/add-complaints?id=${issue.managementIssueId}`),
          setOverviewIssue,
        ),
      },
    ],
  ...
  return (
    <ListPage
      ...
      toolbar={{
        ...
        pdfDocumentTitle: 'Complaint Status',
      }}
    >
