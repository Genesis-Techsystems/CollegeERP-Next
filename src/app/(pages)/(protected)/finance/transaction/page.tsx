...
const COL_DEFS = {
  siNo: {
    ...
    width: 60,
    flex: 0,
  } as ColDef<FinTransaction>,
  accountentityName: {
    field: "accountentityName",
    headerName: "Entity Name",
    minWidth: 110,
    flex: 1,
  } as ColDef<FinTransaction>,
  vouchertypeCatdetCode: {
    field: "vouchertypeCatdetCode",
  ...
  finCategoryCode: {
    field: "finCategoryCode",
    headerName: "Category",
    minWidth: 90,
    flex: 0.8,
  } as ColDef<FinTransaction>,
  finSubCategoryCode: {
    field: "finSubCategoryCode",
...
function amountRenderer(p: ICellRendererParams<FinTransaction>) {
  ...
  return (
    <span className="text-xs tabular-nums">{n.toLocaleString("en-IN")}</span>
  );
}
