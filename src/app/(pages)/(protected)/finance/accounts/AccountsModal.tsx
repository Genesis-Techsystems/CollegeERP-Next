...
export default function AccountsModal({
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      if (editData) {
        // Angular editDialog: details.accountEntityId + details.createdDt before updateDetails
        await updateAccountEntity(editData.accountEntityId, {
          ...payload,
          accountEntityId: editData.accountEntityId,
      ...
      toastError(
        err,
        editData ? "Update entity failed" : "Create entity failed",
      );
    }
  }
