...
const FinanceSubCategoryPage = lazy(
  () => import("../finance-subcategory/page"),
);
const BankAccountsPage = lazy(() => import("../bank-accounts/page"));
const ChequeBookPage = lazy(() => import("../check-book/page"));
const CheckIssuePage = lazy(() => import("../check-issue/page"));
...
const BudgetEstimationReportPage = lazy(
  () => import("../budget-estimations/page"),
);
...
const PAGE_MAP: Record<string, () => ReactElement> = {
  ...
  "check-issue": () => <CheckIssuePage />,
  "cheque-issue": () => <CheckIssuePage />,
