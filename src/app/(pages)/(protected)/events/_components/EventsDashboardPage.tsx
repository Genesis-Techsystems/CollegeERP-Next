...
import { EVENTS_HUB_SECTIONS } from '../_lib/route-config'
    ...
    <PageContainer className="space-y-5">
      <div className="app-card overflow-hidden">
        <div className="border-b bg-gradient-to-br from-slate-50 to-white px-6 py-10 text-center">
          <CalendarDays className="mx-auto h-12 w-12 text-[hsl(var(--primary))] opacity-90" aria-hidden />
          <h1 className="mt-4 text-xl font-semibold tracking-tight text-[hsl(var(--card-title))]">
            Events
          </h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm text-muted-foreground">
            College events, calendars, and department activities — mirrored from Angular
            events-and-notifications and event-calendar modules.
          </p>
        </div>
        <div className="space-y-6 p-4">
          {EVENTS_HUB_SECTIONS.map((section) => (
