...
type EventsPlaceholderProps = { slug: string }

export function EventsPlaceholder({ slug }: EventsPlaceholderProps) {
    ...
    <PageContainer className="space-y-5">
      <div className="app-card px-6 py-10 text-center">
        ...
        <Button asChild variant="outline" size="sm" className="mt-6">
          <Link href="/events/events-dashboard">Back to Events Dashboard</Link>
        </Button>
      </div>
    </PageContainer>
  )
