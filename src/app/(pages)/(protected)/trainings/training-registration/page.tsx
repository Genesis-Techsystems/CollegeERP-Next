...
type TrainingRow = PlacementTraining & {
  registered: boolean;
  expired: boolean;
};
...
export default function TrainingRegistrationPage() {
  ...
  const [confirmTraining, setConfirmTraining] =
    useState<PlacementTraining | null>(null);
  ...
  const {
    ...
    queryKey: QK.trainings.byCollege(collegeId),
    queryFn: () => listTrainingsByCollege(collegeId),
    enabled: ready,
  });
