    ...
    <PageContainer className="space-y-5">
        ...
        <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader className="pr-8 border-b border-amber-200/80 pb-2">
            <DialogTitle className="text-base font-semibold leading-none text-[hsl(var(--primary))] inline-flex items-center gap-2">
              <span className="inline-flex h-7 w-7 items-center justify-center rounded border border-slate-200 bg-slate-50 text-slate-600">
          ...
          <form onSubmit={submitAddStudentAccount} className="space-y-3 py-2">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-0.5">
                ...
                <Select
                  ...
                  className="[&_button]:h-10 [&_button]:text-[12px] [&_button]:rounded-md [&_button]:border-slate-300 [&_button]:bg-white"
                />
              </div>
              <div className="space-y-0.5">
            ...
            {addPreview && addStudentIdNum ? (
              <div className="flex gap-3 rounded-md border border-sky-300/90 bg-sky-50/50 p-3 shadow-sm">
                <div className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-full border border-slate-200 bg-white text-slate-400">
                  {addPreview.photoUrl ? (
                ...
                <div className="min-w-0 flex-1 space-y-0.5 text-[13px]">
                  ...
                  <p className="text-slate-700">
                    <span className="text-slate-500">ID:</span> {addPreview.hall}
                  </p>
                  <p className="leading-snug text-slate-600">{addPreview.academicLine}</p>
                  <p className="text-slate-700">
                    <span className="text-slate-500">Phone:</span> {addPreview.phone}
                  </p>
                  ...
                  <FormField label="Enter your password" required>
                    <div className="relative">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="absolute right-0 top-1/2 h-8 w-9 -translate-y-1/2 p-0 text-slate-500"
      ...
      >
        <div className="space-y-3 text-[12px]">
          {activeStudent ? (
            <div className="rounded-md border border-[#bde8ee] bg-[#f7fdff] p-2.5">
          ...
          <div className="rounded border border-slate-200 overflow-hidden">
            <table className="w-full text-[12px]">
              ...
              <tbody>
                {roleRows.map((r) => (
                  <tr key={`${r.roleId}-${r.userRoleId ?? 'new'}`} className="border-b border-slate-200 last:border-b-0 hover:bg-slate-50/60">
