  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        href: "/time-table-management/live-class-schedule",
        description: "Schedule live classes from your weekly timetable",
      },
      {
        label: "Live Class Schedules List",
        href: "/time-table-management/live-class-schedule-list",
        description: "View all scheduled live classes",
      },
    ],
  },
];
...
const LIST_SLUGS: Record<string, string> = {
  ...
  "live-class-schedule-list": "Live Class Schedules List",
  ...
  "special-activity-attendance/take-attendance":
    "Take Special Activity Attendance",
};
