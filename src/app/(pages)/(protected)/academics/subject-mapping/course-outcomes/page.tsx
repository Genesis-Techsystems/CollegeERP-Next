        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <Input
              ...
              placeholder="Code *"
              className="h-11 rounded-md border-slate-200 focus-visible:ring-teal-500/30"
            />
            <Select
              value={coCategory}
              ...
              searchable
              className="[&_button[role='combobox']]:h-11 [&_button[role='combobox']]:rounded-md [&_button[role='combobox']]:border-slate-200"
            />
            <Input
              value={coCredits}
          ...
          <textarea
            ...
            rows={3}
            className="min-h-[80px] w-full resize-none overflow-hidden rounded-md border border-slate-200 bg-background p-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/30"
          />
