...
import { Filter, FlaskConical, Search } from 'lucide-react'
...
export default function AssignStudentsToLabBatchesPage() {
  ...
  return (
    <PageContainer>
      ...
      {cardsEnabled ? (
        <div className="app-card mt-4 p-2.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2.5">
            <div className="md:col-span-4 border rounded-sm overflow-hidden bg-white">
              <div className="bg-[#dbeafe] border-b px-3 py-1.5 flex items-center justify-between text-sm font-semibold">
                <span>STUDENTS</span>
            ...
            <div className="md:col-span-7 border rounded-sm overflow-hidden bg-white">
              <div className="bg-[#dbeafe] border-b px-3 py-1.5 flex items-center justify-between text-sm font-semibold">
