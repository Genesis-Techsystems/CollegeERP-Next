...
export function HostelDetailModal({
  open,
  onClose,
  row,
  onSaved,
}: Readonly<HostelDetailModalProps>) {
    ...
    >
      <div className="space-y-3">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <div className="space-y-1">
            <Label className={HOSTEL_FIELD_LABEL_CLASS}>Phone Number *</Label>
            <Input
              required
              className={HOSTEL_INPUT_CLASS}
          ...
          <div className="space-y-1 md:col-span-2">
            <Label className={HOSTEL_FIELD_LABEL_CLASS}>Hostel Address *</Label>
            <Input
              required
              className={HOSTEL_INPUT_CLASS}
