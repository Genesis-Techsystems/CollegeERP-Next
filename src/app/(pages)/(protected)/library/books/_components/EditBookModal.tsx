  ...
  const libraryOptions = useMemo<SelectOption[]>(
    () =>
      libraries.map((lib) => ({
        ...
        label:
          lib.libraryCode ?? lib.libraryName ?? String(lib.libraryId ?? ""),
      })),
    [libraries],
  );
  ...
  const departmentOptions = useMemo<SelectOption[]>(
    () =>
      departments.map((cat) => ({
        ...
        label:
          cat.bookCategoryCode ??
          cat.bookCategoryName ??
          String(cat.bookcatId ?? ""),
      })),
    [departments],
  );
