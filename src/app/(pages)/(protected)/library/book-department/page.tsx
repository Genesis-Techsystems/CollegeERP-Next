...
const COL_DEFS = {
  siNo: { headerName: 'SI.No', valueGetter: rowIndexGetter, width: 70, flex: 0 } as ColDef<LibraryBookCategory>,
  orgCode: { field: 'orgCode', headerName: 'Org', minWidth: 90 } as ColDef<LibraryBookCategory>,
  libraryName: { field: 'libraryName', headerName: 'Library', minWidth: 120 } as ColDef<LibraryBookCategory>,
  bookCategoryCode: { field: 'bookCategoryCode', headerName: 'Code', minWidth: 100 } as ColDef<LibraryBookCategory>,
  bookCategoryName: { field: 'bookCategoryName', headerName: 'Department', minWidth: 160 } as ColDef<LibraryBookCategory>,
  isActive: { field: 'isActive', headerName: 'Status', minWidth: 100, flex: 0 } as ColDef<LibraryBookCategory>,
  actions: { headerName: 'Actions', minWidth: 86, width: 86, flex: 0 } as ColDef<LibraryBookCategory>,
}
