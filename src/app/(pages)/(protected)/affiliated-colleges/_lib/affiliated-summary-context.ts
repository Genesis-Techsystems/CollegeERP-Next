...
export const AFFILIATED_SUMMARY_CONTEXT_KEY = 'affiliated-student-summary-context'
  ...
  const fk_regulation_id =
    options?.selectedRegulationId != null
      ...
      : resolveRegulationFromFilterContext({
          ...
          contextRegulationId: pickRowId(row, ['fk_regulation_id', 'regulationId']),
          regulationCode,
        })
...
export function saveAffiliatedSummaryContext(ctx: AffiliatedSummaryContext): void {
