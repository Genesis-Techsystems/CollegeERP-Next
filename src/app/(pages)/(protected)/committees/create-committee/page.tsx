...
const COL_DEFS = {
  ...
  departmentCatdetName: {
    field: "departmentCatdetName",
  ...
  committeeResponsibilities: {
    field: "committeeResponsibilities",
    headerName: "Committee Responsibilities",
    minWidth: 180,
    flex: 1.2,
  } as ColDef<UnivCommittee>,
  isActive: {
