...
function ActionCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex w-40 flex-col items-center rounded-md bg-primary px-4 py-4 text-white shadow-sm transition hover:bg-[#3f9e96]"
    >
      <span className="mb-2 inline-flex h-14 w-14 items-center justify-center rounded-full bg-card text-[#47aea5ed]">
        {icon}
      </span>
