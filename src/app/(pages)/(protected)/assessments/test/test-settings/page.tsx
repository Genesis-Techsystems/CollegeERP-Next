        ...
        {loading ? (
          ...
          <div className="space-y-5">
            <section className="space-y-3">
              <h3 className="rounded-md bg-[#47aea5ed] px-3 py-1 text-sm font-semibold uppercase text-white">Time Settings</h3>
              <div className="grid grid-cols-1 items-end gap-3 md:grid-cols-4">
                ...
                <p className="text-xs text-slate-500">( Duration of Test )</p>
              </div>
            </section>

            <section className="space-y-3">
              <h3 className="rounded-md bg-[#47aea5ed] px-3 py-1 text-sm font-semibold uppercase text-white">Attempt Settings</h3>
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
                ...
                <div className="md:col-span-3 flex flex-wrap items-center gap-4">
                  ...
                  <span className="text-xs text-slate-500">( Max attempts to attend a Test )</span>
                </div>
              </div>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            ...
            <section className="space-y-3">
              <h3 className="rounded-md bg-[#47aea5ed] px-3 py-1 text-sm font-semibold uppercase text-white">Resume</h3>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
                ...
                <div className="md:col-span-3 space-y-2">
                  ...
                  <p className="text-xs text-slate-500">( Users can restart the test from where they stopped in unexpected circumstances )</p>
                </div>
              </div>
            </section>

            <section className="space-y-3">
              <h3 className="rounded-md bg-[#47aea5ed] px-3 py-1 text-sm font-semibold uppercase text-white">Appearance</h3>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            ...
            <section className="space-y-3">
              <h3 className="rounded-md bg-[#47aea5ed] px-3 py-1 text-sm font-semibold uppercase text-white">Test Evaluation</h3>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            ...
            <section className="space-y-3">
              <h3 className="rounded-md bg-[#47aea5ed] px-3 py-1 text-sm font-semibold uppercase text-white">Privacy Settings</h3>
              <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
