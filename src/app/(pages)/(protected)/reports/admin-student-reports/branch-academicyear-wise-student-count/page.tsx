...
/**
 * Branch / Academic Year Wise Student Count —
 * Angular `reports/student-admission-reports/branch-academicyear-wise-student-count` parity.
 * Get List: `getAllRecords/s_get_student_reports?in_flag=adm_branch_acyr_count&…`
 */
...
const REPORT_TITLE = "Student Count Report";
...
export default function BranchAcademicyearWiseStudentCountPage() {
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap items-end gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2 pb-0.5">
              ...
              >
                {loadingList ? "Loading…" : "Get Students Count"}
              </Button>
              <Button
                type="button"
                variant="secondary"
