 ...
 * Angular `reports/student-admission-reports/branch-and-academicyear-wise-caste-count` parity.
 * Get List: `getAllRecords/s_get_student_reports?in_flag=branch_acyr_caste&…`
 */
...
const REPORT_TITLE = "Student Count By Caste Report";
...
const EXCEL_COLUMNS = [
  ...
  { key: "Sub_Caste", header: "Sub Caste" },
...
export default function BranchAndAcademicyearWiseCasteCountPage() {
  ...
  const exportFlatRows = useMemo(
    () =>
      rows.map((row, i) => ({
        ...
        Sub_Caste: String(row.Sub_Caste ?? ""),
