      ...
      filters={
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              type="button"
              className="app-control inline-flex h-9 min-w-20 cursor-pointer items-center justify-center rounded-[5px] border-0 bg-amber-400 px-4 font-medium text-slate-900 shadow-sm transition-colors hover:bg-amber-500"
              onClick={goBack}
            >
              Back
            </button>
