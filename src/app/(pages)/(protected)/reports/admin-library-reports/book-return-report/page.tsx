...
/**
 * Day Wise Book Returns —
 * Angular `reports/admin-library-reports/book-return-report` parity.
 */
...
const PRINT_REPORT_TITLE = "Day Wise Book Return Report";

export default function BookReturnReportPage() {
  ...
  const handleGetList = async () => {
    ...
    if (!fromDate) {
      toastInfo("Report Date is required");
      return;
    }
    ...
    setCollegeName(name);
    try {
      const raw = await getDayWiseBookReturnReport({
        fromDate: f,
        libraryId: lid,
  ...
  const handleExcelExport = () => {
    ...
    exportHtmlTableAsExcel(
      "Day Wise Book Return Report.xls",
