...
const COLS: ColDef<Row>[] = [
  ...
  },
  {
    ...
    minWidth: 140,
    flex: 1,
    valueGetter: (p) => dash(p.data?.subject_name),
  },
  {
    headerName: "Subject Code",
    minWidth: 110,
    flex: 0,
    valueGetter: (p) => dash(p.data?.subject_code),
  },
  {
    headerName: "Employee",
    minWidth: 180,
  ...
  },
  {
    ...
    minWidth: 160,
    flex: 1,
    valueGetter: (p) => dash(p.data?.description),
  },
];
  ...
  useEffect(() => {
    async function init() {
      ...
      try {
        ...
        const colleges = dedupeBy(list, (r) =>
          num(r.fk_college_id ?? r.collegeId),
        );
        if (colleges[0])
          setCollegeId(
            ...
            <div className="inv-allot-report-filters__fx20 space-y-1">
              ...
              <Select
                ...
                options={colleges.map((r) => ({
                  ...
                  label:
                    txt(r.college_code ?? r.collegeCode) ||
            ...
            <div className="inv-allot-report-filters__fx20 space-y-1">
              ...
              <Select
                ...
                options={courses.map((r) => ({
                  ...
                  label:
                    txt(r.course_code ?? r.courseCode) ||
                    String(num(r.fk_course_id)),
                }))}
            ...
            <div className="inv-allot-report-filters__fx20 space-y-1">
              ...
              <Select
                ...
                options={courseGroups.map((r) => ({
                  ...
                  label:
                    txt(r.group_code ?? r.groupCode) ||
                    String(num(r.fk_course_group_id)),
                }))}
                disabled={!courseId}
              />
            </div>
