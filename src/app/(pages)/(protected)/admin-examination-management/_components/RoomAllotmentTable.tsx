            ...
            <tr className="border-b">
              ...
              <td className="px-2 py-1 text-center">
                <Input
                  ...
                  value={globalRows || 0}
                  onChange={(e) =>
                    onGlobalRowsCols(Number(e.target.value) || 0, globalCols)
                  }
                />
              </td>
              <td className="px-2 py-1 text-center">
                <Input
                  ...
                  value={globalCols || 0}
                  onChange={(e) =>
                    onGlobalRowsCols(globalRows, Number(e.target.value) || 0)
                  }
                />
              </td>
              <td className="px-2 py-1 text-center">
              ...
              <tr key={String(r.pk_room_id ?? i)} className="border-b">
                ...
                <td className="px-2 py-1">
                  <Input
                    ...
                    disabled={Boolean(r.disabled)}
                    onChange={(e) =>
                      onRowPriority(i, Number(e.target.value) || 0)
                    }
                  />
                </td>
                <td className="px-2 py-1 text-center">
                  <Input
                    ...
                    disabled={Boolean(r.disabled)}
                    onChange={(e) =>
                      onRowCol(i, "rows", Number(e.target.value) || 0)
                    }
                  />
                </td>
                <td className="px-2 py-1 text-center">
                  <Input
                    ...
                    disabled={Boolean(r.disabled)}
                    onChange={(e) =>
                      onRowCol(i, "cols", Number(e.target.value) || 0)
                    }
                  />
                </td>
                <td className="px-2 py-1 text-center">
