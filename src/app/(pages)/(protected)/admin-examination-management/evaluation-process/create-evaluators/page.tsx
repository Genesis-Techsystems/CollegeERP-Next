...
type FormState = {
  ...
  aadhar: string;
  panCardNo: string;
  /** Angular: travelToEvaluationCenter (optional number) */
...
function validateEvaluatorFields(form: FormState): Record<string, string> {
  ...
  if (!form.isEmp && !form.collegeId)
    errors.collegeId = "University College is required.";
  ...
  if (!RE_PHONE.test(form.phoneNumber.trim()))
    errors.phoneNumber = "Phone Number must be 10 digits starting with 6-9.";
  if (!RE_PHONE.test(form.alternatePhoneNumber.trim())) {
    errors.alternatePhoneNumber =
      "Alternate Phone must be 10 digits starting with 6-9.";
  }
  if (!RE_AADHAR.test(form.aadhar.trim()))
  ...
  if (!form.profileValidFromDate)
    errors.profileValidFromDate = "Start Date is required.";
  if (!form.profileValidToDate)
    errors.profileValidToDate = "End Date is required.";
  if (!form.isActive && !form.reason.trim())
    errors.reason = "Reason is required when inactive.";
  return errors;
}
...
export default function CreateEvaluatorsPage() {
  ...
  function onSelectEmployeeId(employeeId: string | null) {
    ...
    setForm((p) => ({
      ...
      evaluatorName:
        emp?.firstName != null ? String(emp.firstName) : p.evaluatorName,
  ...
  async function onSave() {
    ...
    const payload: AnyRow = {
      ...
      // Angular submit(): travelToEvaluationCenter from form (number or empty)
      travelToEvaluationCenter: form.travelToEvaluationCenter.trim()
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div className="space-y-1">
              ...
              <Input
                value={form.aadhar}
                onChange={(e) =>
                  setForm((p) => ({ ...p, aadhar: e.target.value }))
                }
                placeholder="Aadhar"
              />
              {fieldErrors.aadhar ? (
            ...
            <div className="space-y-1">
              <Label className="text-[12px]">
                Pan Card No. <span className="text-red-600">*</span>
              </Label>
              <Input
                value={form.panCardNo}
                onChange={(e) =>
                  setForm((p) => ({ ...p, panCardNo: e.target.value }))
                }
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    travelToEvaluationCenter: e.target.value,
                  }))
                }
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((p) => ({
                    ...p,
                    profileValidFromDate: e.target.value,
                  }))
                }
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((p) => ({ ...p, profileValidToDate: e.target.value }))
                }
