    ...
    <PageContainer className="space-y-5">
      ...
      <div className="app-card overflow-hidden">
        <div className="px-3 py-2.5 border-b border-slate-200 bg-slate-50/60 flex items-center justify-between gap-2">
          <h2 className="text-[16px] font-semibold text-[hsl(var(--primary))]">View Answer Sheet</h2>
      ...
      {showList && (
        <>
          <div className="app-card p-3 space-y-2">
            <h3 className="text-[14px] font-semibold text-[hsl(var(--primary))] border-b border-amber-200 pb-2">Summary List ({examName} / {formatDate(examDate || '1990-01-01')})</h3>
          ...
          <div className="app-card p-3 space-y-2">
            <h3 className="text-[14px] font-semibold text-[hsl(var(--primary))] border-b border-amber-200 pb-2">Group Wise List ({examName} / {formatDate(examDate || '1990-01-01')})</h3>
          ...
          <div className="app-card p-3 space-y-2">
            <h3 className="text-[14px] font-semibold text-[hsl(var(--primary))] border-b border-amber-200 pb-2">Detail List ({examName} / {formatDate(examDate || '1990-01-01')})</h3>
