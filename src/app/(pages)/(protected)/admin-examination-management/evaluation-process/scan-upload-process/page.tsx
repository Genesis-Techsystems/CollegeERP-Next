...
export default function ScanUploadProcessPage() {
  ...
  return (
    <PageContainer className="space-y-4">
      ...
      {showResult && (
        <div className="app-card p-3 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2 items-center">
            <div className="md:col-span-3 rounded border bg-muted/40 p-2 text-[13px]">Total Students : <span className="text-blue-700">{totalStudents}</span></div>
            <div className="md:col-span-6 px-2"><div className="h-3 bg-sky-100 rounded"><div className="h-3 bg-sky-500 rounded w-3/5" /></div></div>
            <div className="md:col-span-3 rounded border bg-muted/40 p-2 text-[13px]">AnswerPapers Uploaded : <span className="text-blue-700">{uploadedCount}</span></div>
            <div className="md:col-span-3 rounded border bg-muted/40 p-2 text-[13px]">Attendance Marked : <span className="text-blue-700">{attendanceMarked}</span></div>
            <div className="md:col-span-6 text-center text-[13px] text-slate-600">Waiting for files to be scanning.....</div>
            <div className="md:col-span-3 rounded border bg-muted/40 p-2 text-[13px]">Answer Papers Not uploaded : <span className="text-blue-700">{notUploaded}</span></div>
          </div>
        </div>
      )}
      ...
      {showResult && (
        <div className="app-card p-3 space-y-3">
          <div className="px-1 app-card-title">Scanned Files - {detailsLabel || '-'}</div>
              ...
              <tbody>
                ...
                {filteredUploadedFiles.length === 0 && (
                  <tr className="border-t">
                    <td className="px-2 py-4 text-center text-muted-foreground" colSpan={5}>No files selected</td>
                  </tr>
                )}
              </tbody>
            </table>
