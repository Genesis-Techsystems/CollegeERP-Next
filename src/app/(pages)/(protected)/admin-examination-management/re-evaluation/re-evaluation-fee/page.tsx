    ...
    <PageContainer className="space-y-4">
      ...
      {showProfile && studentRow && (
        <div className="app-card p-3 border-t-[3px] border-t-amber-300">
          ...
          <div className="mt-3 rounded-md border border-blue-200 bg-slate-50/80 p-3">
            <div className="flex flex-col gap-3 md:flex-row md:items-start">
              <div className="flex h-24 w-24 shrink-0 items-center justify-center overflow-hidden rounded-md border bg-white">
                {photoSrc ? (
              ...
              <div className="min-w-0 flex-1 space-y-1 text-[13px]">
                ...
                <p className="text-slate-500">{strFrom(studentRow, ['rollNumber', 'roll_number', 'hallticketNumber', 'hallticket_number']) || '-'}</p>
                ...
                <p className="text-slate-500">{strFrom(studentRow, ['mobile', 'phone', 'studentMobile']) || '-'}</p>
              </div>
