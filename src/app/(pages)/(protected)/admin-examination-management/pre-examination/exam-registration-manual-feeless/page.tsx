    ...
    <PageContainer className="space-y-4">
      ...
      {hasFetched && (
        <div className="app-card p-3 space-y-2">
          <div className="rounded border bg-muted/40 px-3 py-2 text-[12px]">
            ...
            <span className="text-muted-foreground"> - {pickText(selectedExam, ['examName', 'exam_name']) || '-'}</span>
          </div>
          <div className="rounded border px-3 py-3 bg-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-2">
            <div className="md:col-span-7 rounded border overflow-hidden">
              ...
              <div className="max-h-[320px] overflow-auto divide-y">
                <label className="px-3 py-2 flex items-center gap-2 text-[12px] bg-muted/40">
            ...
            <div className="md:col-span-5 rounded border overflow-hidden">
              <div className="px-3 py-2 text-[12px] border-b bg-muted/40">
