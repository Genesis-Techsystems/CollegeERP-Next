    ...
    <PageContainer className="space-y-5">
      ...
      <div className="app-card p-3">
        <div className="border-b border-yellow-200 pb-2">
          <h2 className="text-[15px] font-semibold leading-tight text-[hsl(var(--card-title))]">Secure Marks Entry</h2>
        </div>
          ...
          <div className="app-card overflow-hidden border border-[#c3d9ff]">
            <div className="flex items-start gap-4 p-3">
              ...
              <div className="space-y-1 text-[13px]">
                ...
                <p className="text-slate-500">/ {selectedCollege?.college_code ?? '-'} / {selectedCourse?.course_code ?? '-'} / {selectedGroup?.group_code ?? '-'} / {selectedYear?.course_year_code ?? '-'} / <span className="text-blue-700">({selectedAcademicYear?.academic_year ?? '-'})</span></p>
