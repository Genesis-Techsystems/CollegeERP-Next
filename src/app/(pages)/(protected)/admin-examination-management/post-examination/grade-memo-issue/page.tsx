    ...
    <PageContainer className="space-y-4">
      ...
      {mode === 'section' && groupedByStudent.length > 0 && (
        <div className="app-card p-3 overflow-x-auto">
          ...
          <p className="text-[12px] text-slate-500 mb-2">Memo Date: {memoDate}</p>
          ...
          {gradesRows.length > 0 && <p className="text-[12px] text-slate-500 mt-2">Grade scale loaded for selected regulation.</p>}
        </div>
      )}
    </PageContainer>
  )
