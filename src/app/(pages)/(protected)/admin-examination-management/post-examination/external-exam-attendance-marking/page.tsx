    ...
    <PageContainer className="space-y-5">
      ...
      <div className="app-card overflow-hidden">
        <div className="px-3 py-2.5 border-b border-slate-200 bg-slate-50/60 flex items-center justify-between gap-2">
          <h2 className="text-[16px] font-semibold text-[hsl(var(--primary))]">External Exam Attendance Marking</h2>
      ...
      {hasFetched && (
        <div className="space-y-3">
          <div className="app-card overflow-hidden">
            <div className="border-b border-[#c3d9ff] bg-slate-50 px-3 py-2 text-[22px] leading-none text-[#315f8a]">◉</div>
            <div className="border-2 border-[#c3d9ff] bg-white p-2">
          ...
          <div className="app-card overflow-hidden">
            <div className="grid grid-cols-1 gap-3 p-3 lg:grid-cols-12">
              ...
              <div className="space-y-3 lg:col-span-3">
                <div className="overflow-hidden rounded border border-[#c3d9ff] bg-white">
