          ...
          <div className="app-card overflow-hidden border border-[#c3d9ff]">
            <div className="flex items-start gap-4 p-3">
              ...
              <div className="space-y-1 text-[13px]">
                ...
                <p className="text-slate-500">/ {selectedCollege?.college_code ?? '-'} / {selectedCourse?.course_code ?? '-'} / {selectedGroup?.group_code ?? '-'} / {selectedYear?.course_year_code ?? '-'} / <span className="text-blue-700">({selectedAy?.academic_year ?? '-'})</span></p>
