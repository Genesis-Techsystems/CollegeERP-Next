...
import { APP_STEPS, type AppStepId } from './application-form-utils'

export interface ApplicationFormStepperProps {
  activeStep: AppStepId
  progress: number
  onStepClick?: (step: AppStepId) => void
}
...
export function ApplicationFormStepper({
  ...
  return (
    <div className="overflow-hidden rounded-md border border-[#dbe8f6] bg-[#f6fbff]">
      ...
      <div className="grid grid-cols-2 gap-y-2 px-3 py-2 sm:grid-cols-3 lg:grid-cols-6 sm:gap-y-0 sm:px-4">
