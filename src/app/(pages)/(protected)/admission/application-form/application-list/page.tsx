...
const COL_DEFS = {
  siNo: {
    ...
    width: 70,
    flex: 0,
  } as ColDef<StudentApplicationFormRow>,
  applicationNumber: {
  ...
  currentWorkflowStatusName: {
    field: "currentWorkflowStatusName",
    headerName: "Status",
    minWidth: 120,
  } as ColDef<StudentApplicationFormRow>,
  actions: {
...
function photoRenderer(p: ICellRendererParams<StudentApplicationFormRow>) {
  return (
    <div className="flex items-center justify-center h-full pt-1">
      <Avatar className="h-8 w-8">
        <AvatarImage src={p.data?.studentPhotoPath || undefined} />
        <AvatarFallback>
      ...
      <div className="flex items-center gap-0.5">
        <Button
          ...
          onClick={() => {
            ...
            router.push(
              `/admission/application-form/edit-application-form?${params}`,
            );
          }}
        >
...
export default function ApplicationListPage() {
  ...
  const courseOptions = useMemo(
    () =>
      filterCourses(filtersData, collegeId ? Number(collegeId) : null).map(
        courseOption,
      ),
  ...
  const columnDefs = useMemo<ColDef<StudentApplicationFormRow>[]>(() => {
    ...
    if (!isAdmin) {
      return [
        { ...COL_DEFS.siNo, headerName: "Sl.No" },
        {
          headerName: "Photo",
          width: 80,
        ...
        { ...COL_DEFS.applicationNumber, headerName: "Application No." },
        { ...COL_DEFS.firstName, headerName: "Student Name" },
        { ...COL_DEFS.adminssionDate, headerName: "Date of Admission" },
        { ...COL_DEFS.courseName, headerName: "Course" },
        { ...COL_DEFS.genderName, headerName: "Gender" },
        { ...COL_DEFS.mobile, headerName: "Mobile Number" },
        {
      ...
      toolbarTrailing={
        <Button
          ...
          onClick={() => {
            ...
            router.push(
              `/admission/application-form/add-application-form?${params}`,
            );
          }}
        >
