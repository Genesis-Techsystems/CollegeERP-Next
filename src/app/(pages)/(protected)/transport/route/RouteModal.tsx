...
export function RouteModal({ open, onClose, row, onSaved }: Readonly<RouteModalProps>) {
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
          ...
          <div className="space-y-1">
            ...
            <Input className={TRANSPORT_INPUT_CLASS} {...register('routeCode')} />
          </div>
          <div className="space-y-1">
            <Label className={TRANSPORT_FIELD_LABEL_CLASS}>Pickup Place</Label>
            <Input className={TRANSPORT_INPUT_CLASS} {...register('routePickupPlace')} />
          </div>
        </div>
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div className="space-y-1">
            <Label className={TRANSPORT_FIELD_LABEL_CLASS}>Drop Place</Label>
            <Input className={TRANSPORT_INPUT_CLASS} {...register('routeDropPlace')} />
          </div>
        </div>
        <Controller
          name="isActive"
