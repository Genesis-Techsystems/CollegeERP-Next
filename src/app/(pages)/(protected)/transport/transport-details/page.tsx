...
export default function TransportDetailsPage() {
  ...
  return (
    <ListPage
      ...
      toolbar={{
        search: true,
        // Same idea as searching Course Name on Courses — shared org/campus codes
        // (GUG / UNIVCAMP on every row) must not keep the full list visible.
        searchFields: ["transportName"],
