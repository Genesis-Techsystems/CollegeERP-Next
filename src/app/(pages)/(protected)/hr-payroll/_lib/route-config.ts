...
export const HR_PAYROLL_HUB_SECTIONS: {
...
}[] = [
  {
    ...
    cards: [
      ...
      {
        label: "Employee Enrolment",
        href: "/hr-payroll/employee/employee-enrollement",
      },
      { label: "Department Heads", href: "/hr-payroll/department-heads" },
      {
        label: "Reporting Manager",
        href: "/hr-payroll/employee/reporting-manager",
      },
      {
        label: "Biometric Employees",
        href: "/hr-payroll/employee/biometric-employees",
      },
      {
        label: "Attendance Monitor",
        href: "/hr-payroll/employee/attendance-monitor",
      },
    ],
  },
  {
    ...
    cards: [
      { label: "Leave Types", href: "/hr-payroll/leave-management/leave-type" },
      {
        ...
        href: "/hr-payroll/leave-management/leave-entitlement",
      },
      {
        label: "Employee Leave Allotment",
        href: "/hr-payroll/leave-management/employee-leave-allotment",
      },
      {
        label: "Apply Leave",
        href: "/hr-payroll/leave-management/applye-leave",
      },
      {
        label: "Leave Applications",
        href: "/hr-payroll/leave-management/leave-application",
      },
      {
        label: "Biometric Attendance",
        href: "/hr-payroll/leave-management/biometric-attendance",
      },
    ],
  },
  {
    ...
    cards: [
      {
        ...
        href: "/hr-payroll/payroll/payroll-category",
      },
      {
        label: "Payroll Settings",
        href: "/hr-payroll/payroll/payroll-settings",
      },
      { label: "Payroll Groups", href: "/hr-payroll/payroll/payroll-group" },
      {
        label: "Payslip For Employees",
        href: "/hr-payroll/payroll/payslip-for-employees",
      },
      {
        label: "Monthly Payslip",
        href: "/hr-payroll/payroll/monthly-playslip",
      },
      {
        label: "Pre Payroll Audit",
      ...
      {
        label: "Enter Loss Of Pay",
        href: "/hr-payroll/payroll/enter-loss-of-pay",
      },
  ...
  },
  {
    ...
    cards: [
      {
        label: "Service Book Entries",
        href: "/hr-payroll/service-book/service-book-entries",
      },
      {
        label: "Employee Wallet",
        href: "/hr-payroll/service-book/employee-wallet",
      },
    ],
  },
];
...
export const HR_PAYROLL_PAGE_CONFIG: Record<string, HrPayrollPageConfig> = {
  ...
  "employee/edit-enrollement": {
    slug: "employee/edit-enrollement",
  ...
  "payroll/add-payroll-category": {
    slug: "payroll/add-payroll-category",
    title: "Add Payroll Category",
    kind: "form",
  },
  "payroll/edit-payroll-category": {
    slug: "payroll/edit-payroll-category",
    title: "Edit Payroll Category",
    kind: "form",
  },
  ...
  "payroll/payslip-for-employees/generate-payslip": {
    ...
    title: "Generated Employee Payslips",
    kind: "form",
  },
