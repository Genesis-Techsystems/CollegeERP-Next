...
export function GlobalFilterBar({
  ...
  return (
    <div
      className={cn(
        "global-filter-bar app-card overflow-hidden bg-card",
        className,
      )}
    >
      ...
      {open ? (
        <div className="global-filter-bar__inner">
          {leading ? (
            <div className="global-filter-bar__row global-filter-bar__row--leading">
              {leading}
            </div>
          ) : null}
          {children}
...
export function GlobalFilterBarRow({
  children,
  className,
  columns,
