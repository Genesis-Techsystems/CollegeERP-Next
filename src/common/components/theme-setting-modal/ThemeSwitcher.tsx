    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          title="Theme"
          className="flex h-9 w-9 items-center justify-center rounded-md text-[#042956] transition-colors hover:bg-black/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#042956]/30"
        >
