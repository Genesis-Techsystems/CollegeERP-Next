...
export interface RichTextEditorProps {
  ...
  minHeight?: number;
  compact?: boolean;
  /** `full` (default) TinyMCE-style; `quill` matches Angular ngx-quill choice editors */
  toolbarVariant?: "full" | "quill";
  disabled?: boolean;
  className?: string;
}
...
export function RichTextEditor({
  ...
  return (
    ...
    >
      {!compact && <RichTextToolbar editor={editor} variant={toolbarVariant} />}
