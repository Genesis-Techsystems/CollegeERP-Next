...
export const ENTITIES = {
  ...
  EXAM_FCAR_SETUP_MASTER: {
    name: "ExamFCARSetupMaster",
    pk: "examFCARSetMasterId",
  },
  EXAM_ROOM_ALLOTMENT: { name: "ExamRoomAllotment", pk: "examRoomAllotmentId" },
  SEATING_PLAN: { name: "SeatingPlan", pk: "seatingPlanId" },
  INVIGILATOR: {
    name: "InvigilatorRemuneration",
    pk: "invigilatorRemunerationId",
  },
  ...
  STUDENT_ACADEMIC_BATCH: {
    name: "StudentAcademicbatch",
    pk: "studentAcademicbatchId",
  },
  ...
  WORKFLOW_MEMBER_AUTHORIZATION: {
    name: "WorkflowMemberAuthorization",
    pk: "wfMemberAuthorizationId",
  },
  COLLEGE_CERTIFICATE: {
    name: "CollegeCertificate",
    pk: "collegeCertificateId",
  },
  DOCUMENT_REPOSITORY: {
    name: "DocumentRepository",
    pk: "documentRepositoryId",
  },
  ...
  UNIV_FEE_STRUCTURE_DETAILS: {
    name: "UnivFeeStructureDetails",
    pk: "univFeeStructureDetId",
  },
  ...
  SCH_ACCOUNTS_PRECEEDING: {
    name: "SchAccountsPreceeding",
    pk: "schAccountsPreceedingId",
  },
  ...
  STUDENT_APPLICATION_FORMS: {
    name: "studentapplicationforms",
    pk: "studentAppId",
  },
  STUDENT_ENQUIRY: { name: "StudentEnquiry", pk: "enquiryId" },
  CASTE_QUOTA: { name: "CasteQuota", pk: "casteQuotaId" },
  UNIV_COLLEGE_COUNSELLING: {
    name: "UnivCollegeCounselling",
    pk: "univCollegeCounsellingId",
  },
  UNIV_STD_APPLICATIONS: { name: "UnivStdApplications", pk: "univAppId" },
  UNIV_ADMISSION_ALLOTMENT: {
    name: "UnivAdmissionAllotment",
    pk: "univAdmissionAllotmentId",
  },
  UNIV_ADMISSION_ALLOTMENT_DETAILS: {
    name: "UnivAdmissionAllotmentDetails",
    pk: "univAdmissionAllotmentDetailsId",
  },
  // ─── E-Office ────────────────────────────────────────────────────────────────
  OFFICE_LETTER_FORMATS: {
    name: "OfficeLetterFormats",
    pk: "officeLetterFormatsId",
  },
  ...
  INV_ITEM_SUB_CATEGORY: {
    name: "InvItemsubcategory",
    pk: "itemSubcategoryId",
  },
  INV_ITEM_OPENING_STOCK: {
    name: "InvItemopeningStock",
    pk: "itemopeningStockId",
  },
  ...
  // ─── Affiliated Colleges ─────────────────────────────────────────────────────
  UNIV_COLLEGE_WISE_PAYMENT: {
    name: "UnivCollegeWisePayments",
    pk: "univCollegeWisePaymentId",
  },
  // ─── HR & Payroll ────────────────────────────────────────────────────────────
  ...
  EMP_PERF_ASSESSMENT_FEEDBACK: {
    name: "EmpPerfAssessmentFeedback",
    pk: "assessmentFeedbackId",
  },
  EMP_SELF_APPRAISAL_FORM: {
    name: "EmpSelfappraisalForm",
    pk: "selfAppraisalFormId",
  },
  EMP_ATTENDANCE_EMPLOYEE: {
    name: "EmpAttendanceEmployee",
    pk: "attendanceEmpsId",
  },
  SHIFT: { name: "Shift", pk: "shiftId" },
  EMPLOYEE_SHIFT: { name: "EmployeeShift", pk: "empShiftId" },
  // ─── Mentorship / counseling ───────────────────────────────────────────────
  COUNSELOR_ACTIVITY_TYPE: {
    name: "CounselorActivityType",
    pk: "counselorActivityTypeId",
  },
  ...
  LIB_PERIODICAL_DETAIL: { name: "PeriodicalsDetail", pk: "periodicalDetId" },
  ...
  TRANSPORT_ALLOCATION: {
    ...
    pk: "transportAllocationId",
  },
  // ─── TC & No Due / Certificates ────────────────────────────────────────────
  FEE_CERTIFICATE_ISSUE: {
    name: "FeeCertificateIssue",
    pk: "feeCertificateIssueId",
  },
  FEE_CERTIFICATE_WORKFLOW: {
    name: "FeeCertificateWorkflow",
    pk: "feeCertificateWorkflowId",
  },
  // ─── Hostel ────────────────────────────────────────────────────────────────
  ...
  PLACEMENT_BROADCAST: {
    name: "PlacementBroadcast",
    pk: "placementBroadcastId",
  },
  PLACEMENT_COMPANY: { name: "PlacementCompany", pk: "placementCompanyId" },
  PLACEMENT_STUDENT_REG: {
    name: "PlacementStudentRegistration",
    pk: "placementStdRegId",
  },
  ...
  UNIV_COMMITTEE_POSITION: {
    name: "UnivCommitteePositions",
    pk: "univCommitteePositionId",
  },
  UNIV_COMMITTEE_MEMBER: {
    name: "UnivCommitteeMembers",
    pk: "univCommitteeMemberId",
  },
  UNIV_COMMITTEE_MEETING: {
    name: "UnivCommitteeMeetings",
    pk: "univCommitteeMeetingId",
  },
  UNIV_REMUNERATION_SETTING: {
    name: "UnivRemunerationSettings",
    pk: "univRemunerationSettingId",
  },
  UNIV_PROFILE_RECRUITMENT: {
    name: "UnivCommitteeProfilerecruitments",
    pk: "univProfileRecruitmentId",
  },
  UNIV_EXAMINATION_REMUNERATION: {
    name: "UnivExaminationRemunerationDetails",
    pk: "univExaminationRemunerationId",
  },
  // ─── Finance ─────────────────────────────────────────────────────────────────
  ...
  FIN_BUDGET_ALLOCATION: {
    name: "FinBudgetAllocation",
    pk: "finBudgetAllocationId",
  },
  FIN_BUDGET_MIDYEAR: {
  ...
  UNIV_PAYMENT_WALLET_TXN: {
    name: "UnivPaymentWalletTransactions",
    pk: "univPaymentWalletTransactionId",
  },
} as const;
