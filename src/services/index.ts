...
export * from "./group-yearwise-result-report";
export * from "./subject-wise-result-pass-percent-report";
...
export * from "./student-answerpaper-view";
export * from "./student-profile";
export * from "./principal-student-profile";
...
export * from "./hod-dashboard";
export * from "./principal-dashboard";
export * from "./library-dashboard";
export * from "./vc-dashboard";
export * from "./exam-controller-dashboard";
...
export {
  ...
  listAcademicYearsByCollegeForTakeProxy,
  listCoursesByCollegeForTakeProxy,
