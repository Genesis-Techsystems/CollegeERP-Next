...
import { createRevaluationFee, updateRevaluationFee } from '@/services/revaluation-fee'
...
export default function RevaluationFeeModal({
  ...
  const {
    ...
    formError,
    setFormError,
  } = useEntityForm<RevaluationFee, FormValues>(schema, getDefaults, open, editData)
