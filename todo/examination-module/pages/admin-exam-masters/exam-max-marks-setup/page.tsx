...
import { fetchMarksSetup } from '@/services/exam-max-marks'
import { domainSoftDelete } from '@/services/crud'
...
export default function ExamMaxMarksSetupPage() {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) =>
      domainSoftDelete(ENTITIES.EXAM_MARKS_SETUP.name, ENTITIES.EXAM_MARKS_SETUP.pk, id),
    onSuccess: () => {
