 ...
 *   import { getExamFilters, fetchFeeStructures, ... } from '@/services/exam-fee-setup'
 */

import { AppError } from '@/lib/errors'
import { domainList, domainCreate, domainUpdate, domainSoftDelete, buildQuery, getAllRecords } from '@/services/crud'
...
export async function fetchFeeStructuresByExam(examId: number): Promise<ExamFeeStructure[]> {
  ...
  return domainList<ExamFeeStructure>(ENTITIES.EXAM_FEE_STRUCTURE.name, query)
}
...
export async function createFeeStructure(
  ...
  return domainCreate<ExamFeeStructure>(ENTITIES.EXAM_FEE_STRUCTURE.name, payload)
}
...
export async function updateFeeStructure(
  ...
  return domainUpdate<ExamFeeStructure>(
    ...
    ENTITIES.EXAM_FEE_STRUCTURE.pk,
    examFeeStructureId,
    payload,
  )
}
