...
@Component({
  selector: 'app-evter-secure-code',
  templateUrl: './evter-secure-code.component.html',
  styleUrls: ['./evter-secure-code.component.scss']
})
export class EvterSecureCodeComponent implements OnInit {
  evaluatorForm:FormGroup
  constructor(private route: ActivatedRoute, private genericFunctions: GenericFunctions, private formBuilder: FormBuilder, private dialogRef: MatDialogRef<EvterSecureCodeComponent>,
