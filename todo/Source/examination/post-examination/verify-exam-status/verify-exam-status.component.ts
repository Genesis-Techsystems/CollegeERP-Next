...
@Component({
  selector: 'app-verify-exam-status',
  templateUrl: './verify-exam-status.component.html',
  styleUrls: ['./verify-exam-status.component.scss']
})
export class VerifyExamStatusComponent implements OnInit {

  feeFormGroup: FormGroup;
  displayedValues: string[] = [];
  columns = [];
  IntdisplayedColumns: string[] =  ['id', 'course_name', 'course_group', 'academic_year', 'course_year', 'subject_name', 'Int_is_present','Int_mark_entered'];
  // final_int_marks_entered
  displayedColumns: string[] =  ['id', 'course_name', 'course_group', 'academic_year', 'course_year', 'subject_name', 'Student_registered','ext_is_present','1_evaluation_assigned','1_evaluation_evaluated','2_evaluation_assigned','2_evaluation_evaluated','3_evaluation_assigned','3_evaluation_evaluated'];
  ...
  LabdisplayedColumns: string[] = ['id', 'course_name', 'course_group', 'academic_year', 'course_year', 'subject', 'student_present_count','student_enrolled_count','student_marks_entered_count'];
  ...
  trafoexternalItem="External Marks Verify";
  trafointernalItem="Internal Marks Verify";
  trafoItem='Lab Marks Verify'
