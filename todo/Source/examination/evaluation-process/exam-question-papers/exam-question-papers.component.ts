...
import { AddQuestionPapersModalComponent } from './add-question-papers-modal/add-question-papers-modal.component';
@Component({
...
export class ExamQuestionPapersComponent implements OnInit {
 ...
 displayedColumns: string[] = ['id', 'questionPaperTitle', 'setNumber', 'passMarks', 'totalMarks', 'totalQuestions','questionPaperPath','modelAnswerSheetPath','Status','actions'];
 dataSource:any;
...
getExamQuestionpaper(): void{
    /*----------- ExamQuestionpapers -----------*/
        this.crudService.listAllDetails(this.ExamQuestionPaperCrudUrl)
        .subscribe(result => {
           this.spinner.hide();
           if (result.statusCode === 200){
                if (result.data.resultList && result.data.resultList !== '') {
                    this.examQuestionpapers = result.data.resultList;
