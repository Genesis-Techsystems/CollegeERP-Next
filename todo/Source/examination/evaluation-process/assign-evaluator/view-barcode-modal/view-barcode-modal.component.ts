...
@Component({
  selector: 'app-view-barcode-modal',
  templateUrl: './view-barcode-modal.component.html',
  styleUrls: ['./view-barcode-modal.component.scss']
})
export class ViewBarcodeModalComponent implements OnInit {
 ...
 @ViewChild(MatSort) sort: MatSort;
  List=[];
  constructor( private dialogRef: MatDialogRef<ViewBarcodeModalComponent>,private formBuilder: FormBuilder, private snotifyService: SnotifyService,
