...
@Component({
  selector: 'app-assign-questionpaper-template',
  templateUrl: './assign-questionpaper-template.component.html',
  styleUrls: ['./assign-questionpaper-template.component.scss']
})
export class AssignQuestionpaperTemplateComponent implements OnInit {
