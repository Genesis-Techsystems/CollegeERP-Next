...
@Component({
  selector: 'app-print-attendence-marksheet',
  templateUrl: './print-attendence-marksheet.component.html',
  styleUrls: ['./print-attendence-marksheet.component.scss']
})
export class PrintAttendenceMarksheetComponent implements OnInit {
