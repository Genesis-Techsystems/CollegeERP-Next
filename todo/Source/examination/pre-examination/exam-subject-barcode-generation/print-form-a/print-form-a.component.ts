...
@Component({
  selector: 'app-print-form-a',
  templateUrl: './print-form-a.component.html',
  styleUrls: ['./print-form-a.component.scss']
})
export class PrintFormAComponent implements OnInit {
...
ngOnInit(): void {
  if(this.paramaters.AFormData && this.paramaters.AFormData != null){
    ...
    this.orgCode = this.details[0]?.university_code;
    ...
    if(this.details && this.details.length > 0){
      ...
      this.MalpracticeStudents = this.details.filter(x=>(x.isUfm === true))
    }
  }else{
    this.goBack();
  }
