...
@Component({
  selector: 'app-exam-subject-barcode-generation',
  templateUrl: './exam-subject-barcode-generation.component.html',
  styleUrls: ['./exam-subject-barcode-generation.component.scss']
})
export class ExamSubjectBarcodeGenerationComponent implements OnInit {
  ...
  getDetails(): void {
    if (this.examFeeCollectionForm.valid) {
      ...
      this.crudService.listByFourteenIds(this.getExamAllotmentDetailsUrl, 'exam_OMR_students',
        ...
        0,
        0,
        this.examFeeCollectionForm.value.regulationId,
        '1999-01-01',
        '1999-01-01',
          ...
          if (result.statusCode === 200) {
            if (result.success) {
              if (result.data.result[0].length > 0) {
                ...
                this.presensebarcodeList = this.subjectModerationStudents.filter(x => (x.is_present == true))
  ...
  omrpage() {
    ...
    this.router.navigate(['admin-examination-management/admin-pre-examinations/omr-sheets-design'],
      {
        queryParams: {
          data: JSON.stringify(this.subjectModerationStudents),
  ...
  printPresencebarcode() {
    JSON.stringify(this.presensebarcodeList)
    this.router.navigate(['admin-examination-management/admin-pre-examinations/print-barcode-stickers'],
      {
        queryParams: {
          data: JSON.stringify(this.presensebarcodeList),
          collegeCode: this.collegeCode,
          academicyear: this.academicyear,
          courseCode: this.courseCode,
          courseGroupCode: this.courseGroupCode,
