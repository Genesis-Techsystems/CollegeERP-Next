...
@Component({
  selector: 'app-print-additional-exam-fee-receipt',
  templateUrl: './print-additional-exam-fee-receipt.component.html',
  styleUrls: ['./print-additional-exam-fee-receipt.component.scss']
})
export class PrintAdditionalExamFeeReceiptComponent implements OnInit {
