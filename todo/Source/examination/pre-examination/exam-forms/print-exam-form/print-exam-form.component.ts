...
@Component({
  selector: 'app-print-exam-form',
  templateUrl: './print-exam-form.component.html',
  styleUrls: ['./print-exam-form.component.scss']
})
export class PrintExamFormComponent implements OnInit {
...
ngOnInit(): void {
  if(this.paramaters.FormData && this.paramaters.FormData != null){
    this.data = this.paramaters.FormData;
