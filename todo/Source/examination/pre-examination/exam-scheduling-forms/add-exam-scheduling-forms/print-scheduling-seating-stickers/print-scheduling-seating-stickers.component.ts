...
@Component({
  selector: 'app-print-scheduling-seating-stickers',
  templateUrl: './print-scheduling-seating-stickers.component.html',
  styleUrls: ['./print-scheduling-seating-stickers.component.scss']
})
export class PrintSchedulingSeatingStickersComponent implements OnInit {
