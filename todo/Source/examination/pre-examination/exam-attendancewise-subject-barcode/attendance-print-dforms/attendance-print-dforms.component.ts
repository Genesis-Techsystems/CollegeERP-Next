...
@Component({
  selector: 'app-attendance-print-dforms',
  templateUrl: './attendance-print-dforms.component.html',
  styleUrls: ['./attendance-print-dforms.component.scss']
})
export class AttendancePrintDformsComponent implements OnInit {
