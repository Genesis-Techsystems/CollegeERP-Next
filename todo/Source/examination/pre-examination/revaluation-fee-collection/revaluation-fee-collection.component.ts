...
import { DeleteExamRecieptComponent } from './delete-exam-reciept/delete-exam-reciept.component';
import { RevaluationFeePayDialogComponent } from './revaluation-fee-pay-dialog/revaluation-fee-pay-dialog.component';

@Component({
  selector: 'app-revaluation-fee-collection',
  templateUrl: './revaluation-fee-collection.component.html',
  styleUrls: ['./revaluation-fee-collection.component.scss'],
  animations : fuseAnimations
})
export class RevaluationFeeCollectionComponent implements OnInit {
...
getExamCourseYearSubjets(courseYearId): void{
  ...
  deleteExamFeeReceipt(item): void{
    const dialogRef = this.dialog.open(DeleteExamRecieptComponent, {
      width: '650px',
      data: item
    });
  ...
  payExamFees(): void{
    if (this.examFeeCollectionForm.valid){
      ...
      const dialogRef = this.dialog.open(RevaluationFeePayDialogComponent, {
       width: '650px',
