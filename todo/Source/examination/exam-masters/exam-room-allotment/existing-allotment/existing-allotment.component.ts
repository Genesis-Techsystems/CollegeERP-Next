...
import { SeatingOrderComponent } from '../exam-room-allotment-modal/seating-order/seating-order.component';
import { element } from 'protractor';

@Component({
  selector: 'app-existing-allotment',
  templateUrl: './existing-allotment.component.html',
  styleUrls: ['./existing-allotment.component.scss']
})
export class ExistingAllotmentComponent implements OnInit {
