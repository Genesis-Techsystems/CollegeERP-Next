...
@Component({
  selector: 'app-print-groupwise-seating-stickers',
  templateUrl: './print-groupwise-seating-stickers.component.html',
  styleUrls: ['./print-groupwise-seating-stickers.component.scss']
})
export class PrintGroupwiseSeatingStickersComponent implements OnInit {
