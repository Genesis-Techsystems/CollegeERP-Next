...
@Component({
    selector: 'app-exam-room-allotment-modal',
    templateUrl: './exam-room-allotment-modal.component.html',
    styleUrls: ['./exam-room-allotment-modal.component.scss']
})

export class ExamRoomAllotmentModalComponent implements OnInit {
...
selectedTimetable(examTimetableId){
    ...
    addSeat(col): void {
        ...
        const dialogRef = this.dialog.open(SeatingOrderComponent, {
            width: '900px',
            data: col
        });
