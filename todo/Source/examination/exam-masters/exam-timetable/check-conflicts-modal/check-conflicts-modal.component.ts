...
@Component({
  selector: 'app-check-conflicts-modal',
  templateUrl: './check-conflicts-modal.component.html',
  styleUrls: ['./check-conflicts-modal.component.scss']
})
export class CheckConflictsModalComponent implements OnInit {
  ...
  constructor(private formbuilder:FormBuilder,private crudService:CrudService,private genericFunctions: GenericFunctions,private dialogRef: MatDialogRef<CheckConflictsModalComponent>,
