...
@Component({
  selector: 'app-jntu-tr-marks-before-grafting',
  templateUrl: './jntu-tr-marks-before-grafting.component.html',
  styleUrls: ['./jntu-tr-marks-before-grafting.component.scss']
})
export class JntuTrMarksBeforeGraftingComponent implements OnInit {
  panelOpenState = true;
  ...
  trafoItem = "Results Before Grafting";
  collegeName: string;
  examName: any;
  Logo: any;
  orgCode = '';
