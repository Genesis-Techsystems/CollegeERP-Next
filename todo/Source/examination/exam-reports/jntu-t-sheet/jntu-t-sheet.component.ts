...
@Component({
  selector: 'app-jntu-t-sheet',
  templateUrl: './jntu-t-sheet.component.html',
  styleUrls: ['./jntu-t-sheet.component.scss']
})
export class JntuTSheetComponent implements OnInit {
  panelOpenState = true;
              ...
              if(this.examRegisteredStudents && this.examRegisteredStudents.length > 0){
                for(let i = 0;i < this.examRegisteredStudents.length;i++){
                    this.subjects.push({
                     ...
                     'hallticket_number':this.examRegisteredStudents[i]?.hallticket_number
                    })
                }
