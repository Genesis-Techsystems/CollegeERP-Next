...
@Component({
  selector: 'app-external-lab-marks-entered',
  templateUrl: './external-lab-marks-entered.component.html',
  styleUrls: ['./external-lab-marks-entered.component.scss']
})
export class ExternalLabMarksEnteredComponent implements OnInit {
...
this.getMarksList();
  ...
  exportAsExcel()
  {
    ...
    /* save to file */
    XLSX.writeFile(wb, 'External Marks Entered.xlsx');
