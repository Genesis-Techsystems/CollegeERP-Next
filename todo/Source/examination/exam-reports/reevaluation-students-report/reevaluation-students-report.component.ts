...
@Component({
  selector: 'app-reevaluation-students-report',
  templateUrl: './reevaluation-students-report.component.html',
  styleUrls: ['./reevaluation-students-report.component.scss']
})
export class ReevaluationStudentsReportComponent implements OnInit {
  ...
  trafoItem="Re-Evaluation Student Report";
  ...
  selectedCollege(collegeId): void{
    ...
    this.collegeName =this.colleges.filter(x=>x.fk_college_id==collegeId)[0].college_name 
    this.Logo = this.collegeLogo.filter(x=> (x.collegeId == collegeId))[0].logo
    // this.collegeName = this.collegeLogo.filter(x=> (x.collegeId == collegeId))[0].collegeName
