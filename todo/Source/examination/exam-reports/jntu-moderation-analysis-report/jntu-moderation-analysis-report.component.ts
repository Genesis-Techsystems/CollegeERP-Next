...
@Component({
  selector: 'app-jntu-moderation-analysis-report',
  templateUrl: './jntu-moderation-analysis-report.component.html',
  styleUrls: ['./jntu-moderation-analysis-report.component.scss']
})
export class JntuModerationAnalysisReportComponent implements OnInit {
  panelOpenState = true;
  ...
  getDetails() {
    if (this.staffForm.valid) {
      ...
      this.selectedData();
      let request = [
        { paramName: 'in_flag', paramValue: 'exam_analysis_by_subject' },
