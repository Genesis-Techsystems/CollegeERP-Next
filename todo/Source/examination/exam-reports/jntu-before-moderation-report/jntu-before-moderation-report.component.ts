...
@Component({
  selector: 'app-jntu-before-moderation-report',
  templateUrl: './jntu-before-moderation-report.component.html',
  styleUrls: ['./jntu-before-moderation-report.component.scss']
})
export class JntuBeforeModerationReportComponent implements OnInit {
  panelOpenState = true;
  ...
  trafoItem = "Before Moderation Anlysis";
  collegeName: string;
  examName: any;
  Logo: any;
  orgCode = '';
