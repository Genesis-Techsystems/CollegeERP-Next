...
@Component({
  selector: 'app-grace-benefited-students-report',
  templateUrl: './grace-benefited-students-report.component.html',
  styleUrls: ['./grace-benefited-students-report.component.scss']
})
export class GraceBenefitedStudentsReportComponent implements OnInit {
  ...
  panelOpenState = true;
  step = 0;
  trafoItem = "Grace Marks Benefited Students Data";
  collegeCode: any;
  academicYear: any;
  exam: any;
  dataDetails;
