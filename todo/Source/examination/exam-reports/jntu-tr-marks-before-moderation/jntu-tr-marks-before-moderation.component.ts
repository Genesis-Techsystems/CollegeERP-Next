...
@Component({
  selector: 'app-jntu-tr-marks-before-moderation',
  templateUrl: './jntu-tr-marks-before-moderation.component.html',
  styleUrls: ['./jntu-tr-marks-before-moderation.component.scss']
})
export class JntuTrMarksBeforeModerationComponent implements OnInit {
  panelOpenState = true;
  ...
  trafoItem = "Results Before Moderation";
  collegeName: string;
  examName: any;
  Logo: any;
  orgCode = '';
  ...
  getDetails() {
    ...
    if (this.staffForm.valid) {
      ...
      this.selectedData();
      let request = [
        { paramName: 'in_flag', paramValue: 'exam_t_sheet_linear' },
