...
@Component({
  selector: 'app-exam-student-not-registered-count',
  templateUrl: './exam-student-not-registered-count.component.html',
  styleUrls: ['./exam-student-not-registered-count.component.scss']
})
export class ExamStudentNotRegisteredCountComponent implements OnInit {

  displayedColumns: string[] = ['id', 'exam', 'examType', 'examsession', 'college', 'course', 'group', 'year', 'subject', 'notRegisteredStudents'];
  ...
  searchText = '';
  trafoItem = "Exam Students Not Registered";
...
getExamFiltersList(): void {
  ...
  getStudentsList(){
      ...
      if (this.examRegStdForm.valid) {
        ...
        /*----------- SUBJECTS -----------*/
        let request = [
          { paramName: 'in_flag', paramValue: 'exam_std_subject_not_registered' },
          { paramName: 'in_exam_id', paramValue: this.examRegStdForm.value.examId },
