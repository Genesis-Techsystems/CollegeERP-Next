...
@Component({
  selector: 'app-jntu-result-analysis-report',
  templateUrl: './jntu-result-analysis-report.component.html',
  styleUrls: ['./jntu-result-analysis-report.component.scss']
})
export class JntuResultAnalysisReportComponent implements OnInit {
  panelOpenState = true;
  ...
  trafoItem = "Final Result Anlysis";
  collegeName: string;
  examName: any;
  Logo: any;
  orgCode = '';
