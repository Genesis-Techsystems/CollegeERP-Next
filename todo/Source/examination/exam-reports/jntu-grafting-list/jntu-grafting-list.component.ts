...
@Component({
  selector: 'app-jntu-grafting-list',
  templateUrl: './jntu-grafting-list.component.html',
  styleUrls: ['./jntu-grafting-list.component.scss']
})
export class JntuGraftingListComponent implements OnInit {
  panelOpenState = true;
  ...
  getDetails() {
    if (this.staffForm.valid) {
      ...
      this.selectedData();
      let request = [
        { paramName: 'in_flag', paramValue: 'exam_grafted_list' },
