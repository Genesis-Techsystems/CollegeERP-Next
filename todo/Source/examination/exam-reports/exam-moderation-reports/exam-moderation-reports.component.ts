...
@Component({
  selector: 'app-exam-moderation-reports',
  templateUrl: './exam-moderation-reports.component.html',
  styleUrls: ['./exam-moderation-reports.component.scss']
})
export class ExamModerationReportsComponent implements OnInit {
