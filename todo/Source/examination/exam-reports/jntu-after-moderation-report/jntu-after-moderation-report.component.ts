...
@Component({
  selector: 'app-jntu-after-moderation-report',
  templateUrl: './jntu-after-moderation-report.component.html',
  styleUrls: ['./jntu-after-moderation-report.component.scss']
})
export class JntuAfterModerationReportComponent implements OnInit {
  panelOpenState = true;
  ...
  trafoItem = "After Moderation Anlysis";
  collegeName: string;
  examName: any;
  Logo: any;
  orgCode = '';
