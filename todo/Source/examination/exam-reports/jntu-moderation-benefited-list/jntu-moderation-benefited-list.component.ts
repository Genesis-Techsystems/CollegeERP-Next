...
@Component({
  selector: 'app-jntu-moderation-benefited-list',
  templateUrl: './jntu-moderation-benefited-list.component.html',
  styleUrls: ['./jntu-moderation-benefited-list.component.scss']
})
export class JntuModerationBenefitedListComponent implements OnInit {
  panelOpenState = true;
  ...
  trafoItem = "Moderation Analysis Report";
  collegeName: string;
  examName: any;
  Logo: any;
  orgCode = '';
  ...
  getDetails() {
    if (this.staffForm.valid) {
      ...
      this.selectedData();
      let request = [
        { paramName: 'in_flag', paramValue: 'exam_moderatedmarks_added_list' },
