...
@Component({
  selector: 'app-view-gracemarks-model',
  templateUrl: './view-gracemarks-model.component.html',
  styleUrls: ['./view-gracemarks-model.component.scss']
})
export class ViewGracemarksModelComponent implements OnInit {
 ...
 @ViewChild(MatSort) sort: MatSort;
  ...
  ListData: any;
  academicYear='';
  constructor( private dialogRef: MatDialogRef<ViewGracemarksModelComponent>,
