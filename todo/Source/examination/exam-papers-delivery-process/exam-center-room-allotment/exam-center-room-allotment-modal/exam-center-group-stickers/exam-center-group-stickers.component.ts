...
@Component({
  selector: 'app-exam-center-group-stickers',
  templateUrl: './exam-center-group-stickers.component.html',
  styleUrls: ['./exam-center-group-stickers.component.scss']
})
export class ExamCenterGroupStickersComponent implements OnInit {
