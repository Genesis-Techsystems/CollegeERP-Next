...
@Component({
  selector: 'app-exam-center-seating-stickers',
  templateUrl: './exam-center-seating-stickers.component.html',
  styleUrls: ['./exam-center-seating-stickers.component.scss']
})
export class ExamCenterSeatingStickersComponent implements OnInit {
