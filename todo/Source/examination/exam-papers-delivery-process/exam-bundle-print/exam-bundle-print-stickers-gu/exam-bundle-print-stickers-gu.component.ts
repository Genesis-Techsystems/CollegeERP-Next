...
@Component({
  selector: 'app-exam-bundle-print-stickers-gu',
  templateUrl: './exam-bundle-print-stickers-gu.component.html',
  styleUrls: ['./exam-bundle-print-stickers-gu.component.scss']
})
export class ExamBundlePrintStickersGuComponent implements OnInit {
