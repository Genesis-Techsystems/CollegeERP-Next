...
@Component({
  selector: 'app-print-exam-center-barcodes-gu',
  templateUrl: './print-exam-center-barcodes-gu.component.html',
  styleUrls: ['./print-exam-center-barcodes-gu.component.scss']
})
export class PrintExamCenterBarcodesGuComponent implements OnInit {
