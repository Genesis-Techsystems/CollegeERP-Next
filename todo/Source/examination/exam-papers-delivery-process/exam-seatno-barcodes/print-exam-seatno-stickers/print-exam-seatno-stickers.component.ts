...
@Component({
  selector: 'app-print-exam-seatno-stickers',
  templateUrl: './print-exam-seatno-stickers.component.html',
  styleUrls: ['./print-exam-seatno-stickers.component.scss']
})
export class PrintExamSeatnoStickersComponent implements OnInit {
