...
@Component({
  selector: 'app-scan-bundles-modal',
  templateUrl: './scan-bundles-modal.component.html',
  styleUrls: ['./scan-bundles-modal.component.scss']
})
export class ScanBundlesModalComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.dialogTitle = 'Add Scan Bundles';
    ...
    if (!this.isEmptyObject(this.data)) {
        if(this.data.univExamScanbundleId){
           this.dialogTitle = 'Edit Scan Bundles';
           this.addScanBundleForm.get('bundleNumber').setValue(this.data?.bundleNumber);
           ...
           this.addScanBundleForm.get('isActive').setValue(this.data?.isActive);
