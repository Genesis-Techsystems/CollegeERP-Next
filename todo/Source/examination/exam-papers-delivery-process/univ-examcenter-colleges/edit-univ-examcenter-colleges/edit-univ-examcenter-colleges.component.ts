...
@Component({
  selector: 'app-edit-univ-examcenter-colleges',
  templateUrl: './edit-univ-examcenter-colleges.component.html',
  styleUrls: ['./edit-univ-examcenter-colleges.component.scss']
})
export class EditUnivExamcenterCollegesComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private dialogRef: MatDialogRef<EditUnivExamcenterCollegesComponent>,
