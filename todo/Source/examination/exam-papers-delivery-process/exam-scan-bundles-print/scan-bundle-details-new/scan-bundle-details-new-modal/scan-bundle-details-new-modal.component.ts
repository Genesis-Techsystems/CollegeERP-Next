...
@Component({
  selector: 'app-scan-bundle-details-new-modal',
  templateUrl: './scan-bundle-details-new-modal.component.html',
  styleUrls: ['./scan-bundle-details-new-modal.component.scss']
})
export class ScanBundleDetailsNewModalComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private dialogRef: MatDialogRef<ScanBundleDetailsNewModalComponent>,
