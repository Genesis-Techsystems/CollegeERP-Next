...
@Component({
  selector: 'app-exam-scan-bundles-print-stickets-gu',
  templateUrl: './exam-scan-bundles-print-stickets-gu.component.html',
  styleUrls: ['./exam-scan-bundles-print-stickets-gu.component.scss']
})
export class ExamScanBundlesPrintSticketsGuComponent implements OnInit {
