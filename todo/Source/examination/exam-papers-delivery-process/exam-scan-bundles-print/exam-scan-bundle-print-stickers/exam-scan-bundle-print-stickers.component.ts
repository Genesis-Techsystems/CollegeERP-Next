...
@Component({
  selector: 'app-exam-scan-bundle-print-stickers',
  templateUrl: './exam-scan-bundle-print-stickers.component.html',
  styleUrls: ['./exam-scan-bundle-print-stickers.component.scss']
})
export class ExamScanBundlePrintStickersComponent implements OnInit {
