...
export default function EvaluatorAssignedAnswerSheetPage() {
  ...
  const fetchAnswerPapers = useCallback(async () => {
    ...
    try {
      ...
      // const result = await getAssignedAnswerPapers(subjectCode)
      // setAnswerPapers(result)
  ...
  // ── Column definitions (matches Angular headerColumns) ──────────────────
  ...
  const onCellClicked = useCallback((event: CellClickedEvent<AnswerPaper>) => {
    // TODO: navigate to paper evaluation detail page on row click
